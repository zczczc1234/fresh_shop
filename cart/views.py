...
def add_cart(request):
    if request.method == 'POST':
        ...
        if session_goods:
            ...
            # 第一次添加购物车
            # 需要组装购物车中商品格式为[[goods_id , num , is_select]]
