...
def user_center_info(request):
    if request.method == 'GET':
        user_id = request.session.get('user_id')
        goods_record = request.session['goods_record']
        goods_list = []
        for id in goods_record:
        ...
        if user_id:
            ...
            return render(request,'user_center_info.html',{'user':user,'list':list})
